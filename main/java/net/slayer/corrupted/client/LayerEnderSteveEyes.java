...
public class LayerEnderSteveEyes implements LayerRenderer<EntityEnderSteve> {
	
    private static final ResourceLocation RES_ENDERMAN_EYES = new ResourceLocation(SlayerAPI.PREFIX + "textures/models/mobs/endersteve_eyes.png");
    private final RenderEnderSteve endermanRenderer;

    public LayerEnderSteveEyes(RenderEnderSteve endermanRendererIn) {
