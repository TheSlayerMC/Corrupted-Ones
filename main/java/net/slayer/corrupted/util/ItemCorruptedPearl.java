...
public class ItemCorruptedPearl extends ItemMod {

	public ItemCorruptedPearl(String s, String s2) {
		super(s, s2);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if(!worldIn.isRemote)  {
			EntityCorruptedEnderPearl entityenderpearl = new EntityCorruptedEnderPearl(worldIn, playerIn);
