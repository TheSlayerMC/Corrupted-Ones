...
public class SlayerAPI {
	...
	public static int mobID = Config.baseMobID, projectileID = Config.baseProjectileID;
	...
	public static void registerMob(Class entityClass, String name, String finalN, int base, int fore) {
		...
		EntityRegistry.registerModEntity(new ResourceLocation(MOD_ID, name), entityClass, name, mobID++, CorruptedOnes.instance, 128, 5, true, base, fore);
	}
	...
	public static void registerOverworldMob(Class entityClass, String entityName, String finalN) {
		registerMob(entityClass, entityName, finalN, 0x0f5415, 0x23854984);
	}
	...
	public static void registerNPC(Class entityClass, String entityName, String finalN) {
		...
		EntityRegistry.registerModEntity(new ResourceLocation(entityName), entityClass, entityName, mobID++, CorruptedOnes.instance, 128, 5, true, 0x00FF8C, 0x00F6FF);
	}
	
	public static void registerEntity(Class entityClass, String entityName, int ID) {
		EntityRegistry.registerModEntity(new ResourceLocation(entityName), entityClass, entityName, ID, CorruptedOnes.instance, 120, 5, true);
	}

	public static void registerBossMob(Class entityClass, String entityName, String finalN) {
		LangRegistry.addMob(entityName, finalN);
		EntityRegistry.registerModEntity(new ResourceLocation(entityName), entityClass, entityName, mobID++, CorruptedOnes.instance, 128, 5, true, 0x000000, 0x9B0000);
	}

	public static void registerProjectile(Class entityClass, String entityName) {
		EntityRegistry.registerModEntity(new ResourceLocation(entityName), entityClass, entityName + " Projectile", projectileID, CorruptedOnes.instance, 250, 5, true);
		projectileID++;
	}
